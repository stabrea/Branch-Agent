...
export const BUCKETS = {
  ...
  computer: [
    ["screen", "monitor", "Your screen, keyboard and apps", "When Branch may look at and use your screen.",
      [["desktop-card", R], ["linux-desktop-card", R], ["screen-switch-card", A], ["reach-background-card", R], ["reach-usb-card", A], ["os-permissions-card", A]]],
...
export const ICON_PATHS = {
  ...
  assistant: "M12 11a4 4 0 100-8 4 4 0 000 8zM4 21a8 8 0 0116 0",
  ...
  advanced: "M14.5 5.5a4 4 0 00-5.2 5.2L4 16l4 4 5.3-5.3a4 4 0 005.2-5.2l-2.6 2.6-2.6-.6-.6-2.6z",
  about: "M12 21a9 9 0 100-18 9 9 0 000 18zM12 11v6M12 7h.01",
