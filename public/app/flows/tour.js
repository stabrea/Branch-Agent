...
const TOUR = [
  ...
  { sel: '[data-act="modelmenu2"]', prep: chat, title: "Model and thinking", text: "The model and how long it thinks. The choices change with the model." },
  ...
  { sel: ".side-nav", title: "Six places", text: "Overview at a glance, Inbox for what needs you, Automations for work on its own, Library for what it remembers and made, Team for everyone who uses Branch, Customize for Trunks, skills and chat apps." },
  ...
  { sel: ".ch-wrap12", prep: () => { S.view = "customize"; S.tabs.customize = "channels"; }, title: "Every chat app", text: "Each with its real recipe: make the bot, paste what it gives you, Branch checks it, you approve a six-digit code, save." },
