...
export function qr(code, size = 148) {
  ...
  return `<span class="qrbox12"><svg class="qr12" viewBox="0 0 ${size} ${size}" width="${size}" height="${size}" role="img" aria-label="QR code"><rect width="100%" height="100%" rx="10" fill="#fff"/><path d="${d}" fill="#111"/></svg></span>`;
}
