...
export function draw() {
  ...
  html += `<div class="sec"><h2>When one runs out</h2>`
    ...
    + `<div class="ctl"><b>Fall back to this computer</b><input class="sw" type="checkbox" id="ac-fall" aria-label="Fall back to this computer" data-sw="set"><small>When every account is out, keep going on this computer instead of stopping.</small></div></div>`;
