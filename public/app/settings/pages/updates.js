...
function draw() {
  ...
  html += "<div class=\"ctl\"><b>Keep my conversations and settings</b><input class=\"sw\" type=\"checkbox\" id=\"dz-keep\" checked aria-label=\"Keep my conversations and settings\"><small>Branch finds them again if you install it later.</small></div>";
  html += "</div>";
