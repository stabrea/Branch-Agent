...
const RULES = `<div class="sec x15-sec"><h2>Rules for each tool and folder</h2><p class="hint" data-css="margin:0 0 6px">The first rule that matches wins. Everything else follows the mode.</p><div class="rows"></div><div class="acts" data-css="margin-top:8px"><button class="btn sm" type="button" data-act="soon"><svg class="i s" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 5v14M5 12h14"></path></svg>Add a rule</button></div><div class="ctl"><b>Practice runs</b><input class="sw" type="checkbox" id="f15-practice-runs" aria-label="Practice runs" data-sw="set"><small>A Trunk can show what it would do without doing it.</small></div><div class="ctl"><b>Messages per conversation per hour</b><span class="right num15"><input class="inp" aria-label="Messages per conversation per hour"></span><small>Stops a runaway loop.</small></div></div><div class="sec x15-sec"><h2>Checks before anything runs</h2><div class="ctl"><b>Scan commands for hidden characters</b><input class="sw" type="checkbox" id="f15-scan-commands-for-hidden-characters" aria-label="Scan commands for hidden characters" data-sw="set"><small>Invisible and look-alike characters that hide what a command does.</small></div><div class="ctl"><b>Scan for personal details</b><input class="sw" type="checkbox" id="f15-scan-for-personal-details" aria-label="Scan for personal details" data-sw="set"><small>Card numbers, ID numbers and addresses are held back from outside services.</small></div><div class="ctl"><b>Authenticator code for sensitive tools</b><input class="sw" type="checkbox" id="f15-authenticator-code-for-sensitive-tools" aria-label="Authenticator code for sensitive tools" data-sw="set"><small>A six-digit code before sending money or deleting a lot.</small></div></div>`;
