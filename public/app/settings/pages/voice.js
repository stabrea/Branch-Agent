...
export function draw() {
  return `<h1>Voice</h1>
    ...
    <div class="sec"><h2>Talking</h2>
      ...
      <div class="ctl"><b>Push-to-talk key</b><span class="right"><kbd style="font-size:12px;padding:4px 8px">Right Ctrl</kbd></span><small>Hold it anywhere in Windows.</small></div>
    </div>
