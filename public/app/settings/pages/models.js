...
export function draw() {
  return `<h1>Models</h1>
    ...
    <div class="sec"><h2>Connections</h2>
      ...
      <div class="grid2">
        <div class="tile"><b>Claude</b><p>Signed in</p><div class="acts"><span class="pill done" style="margin-left:auto"><i></i>Connected</span></div></div>
    ...
    <div class="sec"><h2>Defaults</h2>
      <div class="ctl"><b>Most conversations</b><span class="right"><select class="inp" data-sw="model-default" style="width:160px"><option>Claude</option><option>ChatGPT</option></select></span><small>The model Trunks use first.</small></div>
    </div>`;
}
