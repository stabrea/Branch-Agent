...
const ADVANCED_EXTRA = `<div class="sec x15-sec"><h2>Phones lent to Branch</h2><div class="rows"></div></div>
  <div class="sec x15-sec"><h2>The browser, more</h2><div class="ctl"><b>Run the browser in a sandbox</b><span class="right"><span class="seg" role="group" aria-label="Run the browser in a sandbox"><button type="button" aria-pressed="false" data-act="seg">Off</button><button type="button" aria-pressed="true" data-act="seg">When needed</button><button type="button" aria-pressed="false" data-act="seg">On</button></span></span><small></small></div><div class="ctl"><b>Record browser tasks</b><input class="sw" type="checkbox" id="f15-record-browser-tasks" checked="" aria-label="Record browser tasks" data-sw="set"><small>A step-by-step trace you can replay.</small></div><div class="ctl"><b>Number the clickable things</b><input class="sw" type="checkbox" id="f15-number-the-clickable-things" checked="" aria-label="Number the clickable things" data-sw="set"><small>Faster and steadier on busy pages.</small></div><div class="ctl"><b>Site skills</b><span class="right"><button class="btn sm" type="button" data-act="site-skills">See the sites</button></span><small>What Branch learned about the sites you use.</small></div><div class="ctl"><b>Page notes and "Send to Branch"</b><input class="sw" type="checkbox" id="f15-page-notes-and-send-to-branch-" aria-label="Page notes and "Send to Branch"" data-sw="set"><small>A right-click in Chrome or Edge sends the page to a Trunk. Turns on when the browser extension is installed.</small></div></div><div class="sec x15-sec"><h2>Code</h2><div class="ctl"><b>Try ideas on a branch</b><input class="sw" type="checkbox" id="f15-try-ideas-on-a-branch" checked="" aria-label="Try ideas on a branch" data-sw="set"><small>A plan can be tried, compared and merged; a forked conversation gets its own copy.</small></div><div class="ctl"><b>Code map</b><input class="sw" type="checkbox" id="f15-code-map" checked="" aria-label="Code map" data-sw="set"><small>A ranked outline of a repository so a Trunk finds its way.</small></div><div class="ctl"><b>Check and format files after editing</b><input class="sw" type="checkbox" id="f15-check-and-format-files-after-editing" checked="" aria-label="Check and format files after editing" data-sw="set"><small></small></div><div class="ctl"><b>AI! and AI? comments start tasks</b><input class="sw" type="checkbox" id="f15-ai-and-ai-comments-start-tasks" checked="" aria-label="AI! and AI? comments start tasks" data-sw="set"><small>Write "AI! add tests" in a file and a Trunk picks it up. On because GitHub is connected.</small></div><div class="ctl"><b>Draft a pull request from a task</b><input class="sw" type="checkbox" id="f15-draft-a-pull-request-from-a-task" checked="" aria-label="Draft a pull request from a task" data-sw="set"><small>Never merged by Branch.</small></div><div class="ctl"><b>Remember the shell</b><input class="sw" type="checkbox" id="f15-remember-the-shell" checked="" aria-label="Remember the shell" data-sw="set"><small>PATH, aliases and functions, so commands behave as in your terminal.</small></div></div>`;
...
const TECHNICAL_EXTRA = `<div class="sec"><h2>Technical</h2><dl class="kv"><dt>Private computer</dt><dd>Windows Sandbox</dd><dt>Browser profile</dt><dd>%APPDATA%\\Branch Agent\\browser-profile</dd><dt>Screen</dt><dd>1280 x 800, 2 frames a second while watched</dd></dl></div><div class="sec x15-sec"><h2>Phones lent to Branch</h2><div class="rows"></div></div>
  <div class="sec x15-sec"><h2>The browser, more</h2><div class="ctl"><b>Run the browser in a sandbox</b><span class="right"><span class="seg" role="group" aria-label="Run the browser in a sandbox"><button type="button" aria-pressed="false" data-act="seg">Off</button><button type="button" aria-pressed="true" data-act="seg">When needed</button><button type="button" aria-pressed="false" data-act="seg">On</button></span></span><small></small></div><div class="ctl"><b>Record browser tasks</b><input class="sw" type="checkbox" id="f15-record-browser-tasks" checked="" aria-label="Record browser tasks" data-sw="set"><small>A step-by-step trace you can replay.</small></div><div class="ctl"><b>Number the clickable things</b><input class="sw" type="checkbox" id="f15-number-the-clickable-things" checked="" aria-label="Number the clickable things" data-sw="set"><small>Faster and steadier on busy pages.</small></div><div class="ctl"><b>Site skills</b><span class="right"><button class="btn sm" type="button" data-act="site-skills">See the sites</button></span><small>What Branch learned about the sites you use.</small></div><div class="ctl"><b>Page notes and "Send to Branch"</b><input class="sw" type="checkbox" id="f15-page-notes-and-send-to-branch-" aria-label="Page notes and "Send to Branch"" data-sw="set"><small>A right-click in Chrome or Edge sends the page to a Trunk. Turns on when the browser extension is installed.</small></div></div><div class="sec x15-sec"><h2>Code</h2><div class="ctl"><b>Try ideas on a branch</b><input class="sw" type="checkbox" id="f15-try-ideas-on-a-branch" checked="" aria-label="Try ideas on a branch" data-sw="set"><small>A plan can be tried, compared and merged; a forked conversation gets its own copy.</small></div><div class="ctl"><b>Code map</b><input class="sw" type="checkbox" id="f15-code-map" checked="" aria-label="Code map" data-sw="set"><small>A ranked outline of a repository so a Trunk finds its way.</small></div><div class="ctl"><b>Check and format files after editing</b><input class="sw" type="checkbox" id="f15-check-and-format-files-after-editing" checked="" aria-label="Check and format files after editing" data-sw="set"><small></small></div><div class="ctl"><b>AI! and AI? comments start tasks</b><input class="sw" type="checkbox" id="f15-ai-and-ai-comments-start-tasks" checked="" aria-label="AI! and AI? comments start tasks" data-sw="set"><small>Write "AI! add tests" in a file and a Trunk picks it up. On because GitHub is connected.</small></div><div class="ctl"><b>Draft a pull request from a task</b><input class="sw" type="checkbox" id="f15-draft-a-pull-request-from-a-task" checked="" aria-label="Draft a pull request from a task" data-sw="set"><small>Never merged by Branch.</small></div><div class="ctl"><b>Remember the shell</b><input class="sw" type="checkbox" id="f15-remember-the-shell" checked="" aria-label="Remember the shell" data-sw="set"><small>PATH, aliases and functions, so commands behave as in your terminal.</small></div></div><div class="sec x15-sec"><h2>On a computer, more</h2><div class="ctl"><b>Work in apps in the background</b><input class="sw" type="checkbox" id="f15-work-in-apps-in-the-background" checked="" aria-label="Work in apps in the background" data-sw="set"><small>Through the accessibility tree, without taking the screen.</small></div><div class="ctl"><b>Read Jupyter notebooks</b><input class="sw" type="checkbox" id="f15-read-jupyter-notebooks" checked="" aria-label="Read Jupyter notebooks" data-sw="set"><small>Cells, outputs and charts.</small></div><div class="ctl"><b>Review checks and a checklist per task</b><input class="sw" type="checkbox" id="f15-review-checks-and-a-checklist-per-task" checked="" aria-label="Review checks and a checklist per task" data-sw="set"><small>Checks you write run before a task says it's done; the checklist shows in the task.</small></div><div class="ctl"><b>Write AGENTS.md for a project</b><span class="right"><code class="code15">/init</code></span><small>Branch reads the project and writes its house rules.</small></div></div>`;
