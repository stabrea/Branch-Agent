...
function labelsSection(labels, helpers) {
  ...
  const id = el("input"); id.placeholder = t("collab.field.number"); id.maxLength = 200; id.setAttribute("aria-label", t("collab.field.numberLabel")); id.dataset.t = "collab.field.number"; id.dataset.tLabel = "collab.field.numberLabel";
  const label = el("input"); label.placeholder = t("collab.label.placeholder"); label.maxLength = 40; label.setAttribute("aria-label", t("collab.label.aria")); label.dataset.t = "collab.label.placeholder"; label.dataset.tLabel = "collab.label.aria";
...
function peopleSection(profile, helpers) {
  ...
  const name = el("input"); name.placeholder = t("household.add.name"); name.maxLength = 40; name.setAttribute("aria-label", t("household.add.name")); name.dataset.t = "household.add.name"; name.dataset.tLabel = "household.add.name";
  const newPin = el("input"); newPin.type = "password"; newPin.inputMode = "numeric"; newPin.placeholder = t("collab.field.pin"); newPin.setAttribute("aria-label", t("collab.field.pinLabel")); newPin.dataset.t = "collab.field.pin"; newPin.dataset.tLabel = "collab.field.pinLabel";
  const adding = el("div", undefined, "collab-row");
