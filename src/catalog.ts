...
const groupPrefixes: readonly (readonly [string, readonly string[]])[] = [
  ...
  ["schedules", ["schedules.", "triggers.", "reminders.", "timers.", "webhooks."]],
...
const groupWords: Record<string, readonly string[]> = {
  ...
  browser: ["browser", "click", "form", "login", "tab", "screenshot", "checkout"],
  ...
  schedules: ["schedule", "remind", "reminder", "tomorrow", "daily", "weekly", "every", "later", "recurring", "alarm"],
