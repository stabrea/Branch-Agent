...
export type RecordTable = "memory" | "specialists" | "procedures" | "schedules" | "settings" | "deliveries" | "governance" | "triggers" | "webhooks" | "workflows" | "flow_graphs" | "prompts";
...
export class Store {
  ...
  constructor(path: string) {
    ...
    for (const table of ["memory", "specialists", "procedures", "schedules", "settings", "deliveries", "governance", "triggers", "webhooks", "workflows", "flow_graphs", "prompts"])
      this.db.exec(
