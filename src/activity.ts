...
export function describeToolCall(name: string, args: unknown, plain?: string | null): string {
  ...
  switch (name) {
    ...
    // Mac mini's E2 part 2 review: where a tool's first sentence reads as a list, carries ids or is jargon, the words are ours.
    case "labels.list": return "Looking at the labels";
    case "workflows.list": return "Looking at the saved workflows";
    case "flows.list": return "Looking at the saved flows";
    case "projects.notes": return "Reading a project's notes";
    case "knowledge.list": return "Looking at the saved recipes and specialists";
    case "troubleshoot.run": return "Running a failed command again to find out why";
    case "desktop.read": return "Reading what is in a window";
    ...
    case "specialists.propose": return "Setting up a specialist";
    case "specialists.evaluate": return "Trying out a specialist";
    case "specialists.promote": return "Putting a specialist to work";
    case "specialists.rollback": return "Putting a specialist back to its last version";
    case "templates.import": return "Adding a specialist or recipe from a template";
    case "media.download": return "Saving a video from a web page";
    case "heartbeat.respond": return "Answering a scheduled check-in";
    case "data.query": return "Looking something up in an open table";
