...
export const RemoveSchema = z.object({
  /** True keeps the folder holding conversations and settings; what Branch fetched still goes. Left out, they are kept: only an explicit false deletes the owner's work. */
  keepConversations: z.boolean().default(true),
...
const PlanSchema = z.object({ keepConversations: z.boolean().default(true) }).strict();
