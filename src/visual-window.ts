 ...
 * how many pictures were taken out. Only messages the task added itself are touched: pictures the
 * owner attached to their own words are never removed.
 */
export function boundPictures(messages: Message[], keep = picturesKeptInView, added: ReadonlySet<Message> = new Set(messages)): number {
