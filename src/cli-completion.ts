...
export const cliCommands: { name: string; summary: string; options: string[] }[] = [
  ...
  { name: "run", summary: "Carry out one task and print the result", options: ["--json", "--attach", "--plan", "--verify", "--dry-run", "--preset", "--budget", "--timeout"] },
  ...
  { name: "doctor", summary: "Check that everything works", options: ["--probe"] },
