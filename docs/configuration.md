...
What this computer allows** (`public/os-permissions.js`) shows the list on a Mac and on Linux, under
"Using your screen and keyboard": each switch with its explanation, on Linux the session type, and on
