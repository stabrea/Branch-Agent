...
| --- | --- | --- |
| Model for planning (R17-044) | Models → Defaults | The connection that drafts the plan when "Show me the plan first" is on; the work is still done by the conversation's model |
