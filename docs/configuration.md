...
- **Backups** copy the list (names, order, caps) and the usage counts, never a key or a token. The program folders are outside the database and are not in a backup either.
