...
/// The key a Branch hands over stays here and in the Keychain; the page never receives it.
...
public class BranchPhonePlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    @objc func getSwitches(_ call: CAPPluginCall) { call.resolve(["switches": BranchSwitches.all()]) }
    ...
    @objc func takeShared(_ call: CAPPluginCall) { call.resolve(["items": []]) }
    @objc func clearShared(_ call: CAPPluginCall) { call.resolve() }
