...
- Have a live conversation: on a connection that offers one (OpenAI or Gemini), press Talk live once and simply talk — your voice goes up as you speak, the answer comes back as it is said, and pressing again cuts it off. You can type while it is talking. What was said on both sides lands in the conversation as ordinary messages; the sound itself is not kept unless you ask for it. Tools the model asks for mid-conversation still wait for your yes, and each conversation stops itself at the minutes and the money you allowed.
