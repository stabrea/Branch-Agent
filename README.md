...
- Use Branch from other AI tools: MCP (Model Context Protocol) server exposes tools, resources, and prompts over HTTP or stdio with session tracking and permission gates, letting other assistants delegate work to Branch.
