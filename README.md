...
- A tool can be found by a few words without opening a whole toolbox, and a tool may hand its work over and finish later: the task carries on, and the answer arrives in the conversation when it comes.
