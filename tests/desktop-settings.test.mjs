...
test("native settings encrypt a key, keep IPC narrow, and connect after restart", {
  ...
  try {
    ...
    assert.deepEqual(await page.evaluate(() => Object.keys(window.branchDesktop).sort()),
      ["checkForUpdates", "closeKeepOak", "disconnectKeepOak", "exportBackup", "exportConversation", "exportMemory", "installUpdate", "modelSettings", "openExternal", "openKeepOak", "restartBranch", "saveModelSettings", "updateStatus"]);
