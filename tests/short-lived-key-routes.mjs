...
export const ROUTES = {
  ...
  // operations.hibernation: the owner's operations, reading included (src/hibernation-api.ts).
  "/api/hibernation": "secret-read",
  "/api/hibernation/": "prefix",
  "/api/hibernation/:id": "secret-read",
  "/api/hibernation/advance": "owner POST",
  "/api/hibernation/operations": "secret-read",
  "/api/hibernation/resume": "owner POST",
  "/api/hibernation/settings": "owner POST",
  "/api/hibernation/start": "owner POST",
  "/api/hibernation/suspend": "owner POST",
  "/api/hooks": "look",
