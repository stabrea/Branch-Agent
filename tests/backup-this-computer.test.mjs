...
import { thisComputerSettings } from "../dist/backup.js";
...
const keys = [...thisComputerSettings, "remote-agent:helper"];

test("the list is what Q168 A names, and devices-book is on it", () => {
  assert.deepEqual([...thisComputerSettings].sort(), ["devices-book", "folder-trust-real", "folder_trust", "folder_trust_mode",
