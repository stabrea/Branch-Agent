/**
 * phase2/settings: Surface parity — part 1 of 3
 * 860px width: all themes share the approved opaque surface at medium size.
 */
...
test(`DG-168 all themes share the approved opaque surface at 860px`, async (t) => {
  const { page, errors } = await fixture(t, 860);
